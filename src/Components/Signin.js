...
const SignIn = ({ setdetails, registernum, setRegisternum }) => {
  ...
  return (
    <div className="container font-MyFont">
      <div className="signin">
        ...
        <div className="Sign text-6xl py-10">
          <h2>SIGN IN</h2>
        </div>
        <form onSubmit={handleSubmit}>
            ...
            <table>
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    className="focus: outline-0 rounded-lg border-2 border-black mb-4 p-1"
                    value={registernum}
              ...
              <tr>
                ...
                <td>
                  <input
                    type="password"
                    className="focus: outline-0 rounded-lg border-2 border-black p-1"
                    value={password}
          ...
          <div className="sub">
            <center>
              <button
                type="submit"
                className="but hover:font-semibold text-white rounded-lg"
              >
                Sign In
              </button>
            </center>
